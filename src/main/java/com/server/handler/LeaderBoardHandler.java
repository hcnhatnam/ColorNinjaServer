...
public class LeaderBoardHandler extends BaseModel {

    private static final Logger LOGGER = Logger.getLogger(LeaderBoardHandler.class);
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            List<ScoreUser> scoreUsers = LeaderBoard.INSTANCE.getLeaderBoardSolo();
